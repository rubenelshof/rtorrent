...
http_archive(
    ...
    strip_prefix = "libtorrent-f069c2498eae496496f425517f8b66c1ccb3a75d",
    url = "https://github.com/rubenelshof/libtorrent/archive/f069c2498eae496496f425517f8b66c1ccb3a75d.zip",
)
